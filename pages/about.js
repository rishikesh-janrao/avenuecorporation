...
function about(props) {
  const bannerDetails = {
    ...
    description: `Avenue Corporation, Fully dedicated to integrity, quality and innovation. <br/> We strive to offer a unique combination of integrated packaging solutions and services unmatched by any other company to be the best.`,
