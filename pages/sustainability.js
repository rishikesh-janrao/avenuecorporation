...
function Sustainability(props) {
  const bannerDetails = {
    ...
    description: `We believe in making our planet a better place to live. Avenue Packs Packaging Solution can help you achieve your environmental goals.`,
  ...
  return (
    <>
      <Head>
        <title>Avenue Packs - Sustainability</title>
